...
#elif defined (PI_GATE_433)
#define RF_LED_PIN NOT_A_PIN         // Led on GPIO4 so P1 connector pin #7
#define RF_CS_PIN  RPI_V2_GPIO_P1_26 // Slave Select on CE0 so P1 connector pin #24
#define RF_IRQ_PIN RPI_V2_GPIO_P1_15 // IRQ on GPIO25 so P1 connector pin #22
#define RF_RST_PIN RPI_V2_GPIO_P1_16 // Reset on GPIO5 so P1 connector pin #29
//#define RF_TXE_PIN RPI_V2_GPIO_P1_24 // Reset on GPIO5 so P1 connector pin #29

#elif defined (PI_GATE_868)
#define RF_LED_PIN NOT_A_PIN         // Led on GPIO4 so P1 connector pin #7
#define RF_CS_PIN  RPI_V2_GPIO_P1_24 // Slave Select on CE0 so P1 connector pin #24
#define RF_IRQ_PIN RPI_V2_GPIO_P1_18 // IRQ on GPIO25 so P1 connector pin #22
#define RF_RST_PIN RPI_V2_GPIO_P1_22 // Reset on GPIO5 so P1 connector pin #29
#define RF_TXE_PIN RPI_V2_GPIO_P1_13 // Reset on GPIO5 so P1 connector pin #29
...
// =========================================
// see https://github.com/dragino/Lora
#elif defined (BOARD_LoRaPi)
#define RF_TX_PIN RPI_V2_GPIO_P1_24 // Led on GPIO19 so P1 connector pin #11
#define RF_CS_PIN  RPI_V2_GPIO_P1_26 // Slave Select on GPIO26
#define RF_IRQ_PIN RPI_V2_GPIO_P1_18 // IRQ on GPIO5
#define RF_RST_PIN RPI_V2_GPIO_P1_22 // Reset on GPIO17 so P1 connector pin #11
#define RF_LED_PIN NOT_A_PIN				 // No onboard led to drive
