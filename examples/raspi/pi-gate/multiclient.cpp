...
#define RF433_NODE_ID    2
#define RF433_FREQUENCY  433.00

// Our 868 gate Configuration
#define RF868_NODE_ID    2
#define RF868_FREQUENCY  868.00

// Our send timer
#define timer_MS_Gate1  3000
#define timer_MS_Gate2  1000
...
int main(int argc, const char* argv[]) {
	...
	uint8_t data433[] = "Hello in 433 MHz";
	uint8_t len433 = sizeof(data433);
	uint8_t data868[] = "Hello in 868 MHz";
