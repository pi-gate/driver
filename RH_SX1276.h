...
// $Id: RH_SX1276.h,v 1.14 2017/01/13 01:29:36 mikem Exp mikem $
// 
...
public:
    ...
    RH_SX1276(uint8_t slaveSelectPin = SS, uint8_t interruptPin = 2, RHGenericSPI& spi = hardware_spi);
...
protected:
    /// This is a low level function to handle the interrupts for one instance of RH_SX1276.
...
private:
    ...
    static RH_SX1276*     _deviceForInterrupt[];
